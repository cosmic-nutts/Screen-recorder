...
// Define the Visibility type (if it's not already defined)
...
const UploadPage = () => {
  ...
  const [formData, setFormData] = useState<VideoFormValues>({
    ...
    description: "",
    tags: "",
    visibility: "public", // Set default visibility value
  });
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      await saveVideoDetails({
        ...
        visibility: formData.visibility, // Ensure visibility is correctly typed
      });
